      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              Transforming the lives of youth around the world through
              mentoring, financial literacy, and entrepreneurship.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-400 text-sm">
                  info@ronnialangstonfoundation.org
                </span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <form className="flex flex-col space-y-2">
              ...
              <button
                type="submit"
                className="bg-blue-600 text-white cursor-pointer px-4 py-2 rounded-md hover:bg-blue-700 transition-colors text-sm font-medium"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm">
            &copy; {new Date().getFullYear()} Ronnia Langston Foundation. All
            rights reserved.
          </p>

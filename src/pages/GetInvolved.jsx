  ...
  const volunteerOpportunities = [
    {
      ...
      description:
        "Guide and inspire young people through one-on-one mentorship relationships.",
    ...
    },
    {
      ...
      description:
        "Help students excel academically by providing subject-specific tutoring support.",
    ...
    },
    {
      ...
      description:
        "Support our community events, fundraisers, and youth activities.",
      commitment: "Flexible",
      icon: "🎉",
      requirements: [
    ...
    },
    {
      ...
      description:
        "Lead workshops on career skills, life skills, or creative expression.",
      commitment: "Monthly",
      icon: "🎯",
      requirements: [
      ...
      <Section className="bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 text-white py-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl opacity-90 leading-relaxed">
            Join us in empowering youth and creating lasting change in our
            community
          </p>
        </div>
      </Section>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {[
              ...
              <button
                ...
                className={`px-6 py-3 rounded-full font-semibold transition-all duration-300 cursor-pointer hover:scale-110 ${
                  activeTab === tab.id
                    ? "bg-gradient-to-r from-blue-600 to-purple-600 text-white shadow-lg scale-105"
                    : "bg-gray-100 text-gray-700 hover:bg-gray-300 hover:shadow-md"
                }`}
              >
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Make a direct impact in the lives of young people by sharing
                your time, skills, and passion.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl p-8 text-center">
              ...
              <p className="text-gray-600 mb-6">
                Contact our Volunteer Coordinator to discuss the best fit for
        ...
        <Section className="py-16">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Partner with us to create meaningful impact while enhancing your
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
              {partnershipLevels.map((level, index) => (
                ...
                >
                  <div
                    className={`h-2 rounded-t-xl bg-gradient-to-r ${level.color} -mt-6 -mx-6 mb-6`}
                  ></div>
                  <h3 className="text-2xl font-bold text-gray-900 mb-2">
                    {level.level}
                  </h3>
                  <div
                    className={`text-3xl font-bold bg-gradient-to-r ${level.color} bg-clip-text text-transparent mb-6`}
                  >
                    {level.amount}
                  </div>
        ...
        <Section className="py-16">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Your generous donation helps us provide life-changing programs to
            ...
            <Card className="bg-gradient-to-br from-purple-50 to-pink-50">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                {["$25", "$50", "$100", "$250"].map((amount) => (
                  <button
                    key={amount}
                    className="py-4 px-6 bg-white rounded-xl cursor-pointer font-bold text-gray-900 hover:bg-gradient-to-r hover:from-purple-600 hover:to-pink-600 hover:text-white transition-all duration-300 shadow-sm hover:shadow-lg"
                  >
                    {amount}
                  </button>
                ))}
            ...
            <p className="text-sm text-gray-500 mt-6">
              Ronnia Langston Foundation is a 501(c)(3) tax-exempt organization.
